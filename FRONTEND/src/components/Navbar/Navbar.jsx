        ...
        <header className="sticky top-0 z-50">
            ...
            >
                <div className="navbar w-full max-w-[1200px] mx-auto px-2 sm:px-6 lg:px-8 min-h-[4rem]">
                    ...
                    {/* DERECHA (End) */}
                    {!isDashboardProductsRoute && (
                        <div className="navbar-end w-1/3 lg:w-1/4 flex justify-end items-center gap-1 sm:gap-3">
                            ...
                            {/* EL ENROQUE: El usuario primero, el carrito al final */}
