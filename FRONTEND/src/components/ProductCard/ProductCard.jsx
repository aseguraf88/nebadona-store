            ...
            >
                ...
                >
                    ...
                    <figure className="relative aspect-square w-full overflow-hidden bg-base-200/30 rounded-t-2xl">
                        ...
                        {/* BOTÓN VISTA RÁPIDA (Más minimalista) */}
                        <button
                            type="button"
                        ...
                        {/* 🔥 BOTÓN AGREGAR (Estilo Píldora Flotante) */}
                        <div className="absolute bottom-3 left-3 right-3 z-20 overflow-hidden rounded-xl">
                            <button
                                onClick={handleAddToCart}
                                disabled={stock === 0 || isAdded}
                                className={`w-full py-2.5 flex items-center justify-center backdrop-blur-md transition-all duration-500 ease-out sm:translate-y-12 sm:opacity-0 sm:group-hover:translate-y-0 sm:group-hover:opacity-100 rounded-xl shadow-md ${
                                    isAdded
                                        ? 'bg-success text-success-content'
                                        : 'bg-base-100/95 text-base-content hover:bg-primary hover:text-primary-content'
                                }`}
                            >
                                {stock === 0 ? (
                    ...
                    {/* BLOQUE INFERIOR DE TEXTO (Más aireado) */}
