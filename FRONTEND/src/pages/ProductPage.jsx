...
import ProductSection from '../components/ProductSection' // Asegúrate de que la ruta sea correcta
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 mb-20">
                    ...
                    <div className="flex flex-col-reverse lg:flex-row gap-4 lg:gap-6">
                        ...
                        {/* IMAGEN PRINCIPAL */}
                        <figure className="aspect-square w-full bg-base-200/50 rounded-3xl overflow-hidden relative flex-1">
                            {images.length > 0 ? (
                                <img
